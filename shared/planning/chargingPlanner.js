import { DEFAULT_ENERGY_OPTIONS, estimateRouteEnergy } from "./energyModel.js";
import {
  clampBatteryRange,
  copyPoint,
...
import { keepFrontierBounded } from "./chargingPlannerFrontier.js";
import { findLegFrontier } from "./chargingPlannerLegs.js";
  ...
  for (let legIndex = 0; legIndex < mandatory.length - 1; legIndex += 1) {
    ...
    for (const label of frontier) {
      const legOptions = findLegFrontier({
        ...
        incomingPoint: label.route.at(-2),
