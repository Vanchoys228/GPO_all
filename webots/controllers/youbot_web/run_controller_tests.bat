...
set SOURCES=controller_avoidance.c controller_avoidance_start.c controller_avoidance_lifecycle.c controller_avoidance_recovery.c controller_avoidance_service.c controller_avoidance_presentation.c controller_camera.c controller_camera_map.c controller_camera_map_io.c controller_camera_render.c controller_camera_fusion.c controller_camera_virtual.c controller_drive.c controller_io.c controller_lidar_math.c controller_lidar_scan.c controller_lidar_trace.c controller_lifecycle.c controller_mapping_obstacles.c controller_mapping_route_io.c controller_mapping_scan.c controller_mapping_scan_service.c controller_mapping_store.c controller_math.c controller_motion_profile.c controller_navigation_context.c controller_navigation_lidar.c controller_navigation_motion_service.c controller_navigation_perception.c controller_navigation_presentation.c controller_navigation_route.c controller_navigation_session.c controller_navigation_service.c controller_navigation_tracking.c controller_navigation_zone_guard.c controller_obstacle_map.c controller_paths.c controller_route.c controller_runtime_command.c controller_step.c controller_survey_contour.c controller_survey_coverage.c controller_survey_generator.c controller_survey_grid.c controller_survey_geometry.c controller_survey_integration.c controller_survey_lifecycle.c controller_survey_route_builder.c controller_survey_state.c controller_telemetry.c controller_telemetry_service.c controller_types.c controller_webots_devices.c controller_webots_adapter.c controller_webots_camera_adapter.c controller_webots_pose.c controller_webots_sensors.c controller_webots_simulation.c controller_zone_geometry.c controller_zones.c
set /a PASSED=0
...
for %%F in (!TEST_PATTERN!) do (
  echo [webots-test] %%F
  cl /nologo /std:c11 /O2 /I"%WEBOTS_HOME%\include\controller\c" "%%F" !SOURCES! /Fe:"%OUTPUT_DIR%\%%~nF.exe" /Fo:"%OUTPUT_DIR%\\" /link /LIBPATH:"%WEBOTS_HOME%\lib\controller" Controller.lib >nul
  if errorlevel 1 (
